...
<div id="footer"  class="footer" style="display: block;">
	...
	<div id="footer_desc" class="footer_desc">
		...
		<div class="descColumn">
			<span class="descColumnTitle">地狗保障</span>
		...
		<div class="descColumn">
			<span class="descColumnTitle">手机地狗</span>
	...
	<div id="copyright" class="copyright">
		<div class="coptyrightMiddle">
			<img id="cateye" class="cateye" src="img/site/Dlogo.png">
			<div class="white_link" >
				<a href="#nowhere" style="padding-left:0px" >关于地狗</a>
			...
			<div class="white_link" >
				...
				<a href="#nowhere" >地狗 </a><span class="slash">|</span>
